...
import { MessageCircle, RotateCcw, Settings, X, Send } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { ThemeToggle } from "@/components/ui/theme-toggle";
import { useEditorStore } from "@/stores/editor-store";
import { useKnowledgeBase } from "@/contexts/knowledge-base-context";
import { KnowledgeBaseSettingsModal } from "../chat/knowledge-base-settings-modal";
import {
    ...
    <div className="flex flex-col h-full bg-background border-r border-border">
      ...
      <div className="flex items-center justify-between p-4 border-b border-border flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold">AI Assistant V5</h2>
          ...
          !isChatLoading && ( // Added !isChatLoading
            <div className="text-center text-muted-foreground py-8">
              ...
              <p className="text-lg font-medium mb-2">
                Welcome to AI Assistant V5
              </p>
              <p className="text-sm">
                Powered by Vercel AI SDK. Start a conversation below.
              </p>
            </div>
          )}
                ...
                switch (part.type) {
                  case "text":
                    return (
                      <div
                        key={index}
                        className={`rounded-lg py-2 px-2  inline-block ${
                          message.role === "user"
